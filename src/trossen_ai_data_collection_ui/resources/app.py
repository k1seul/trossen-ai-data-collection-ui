...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionNew_Task = QAction(MainWindow)
        self.actionNew_Task.setObjectName(u"actionNew_Task")
        ...
        self.pushButton_resetarms = QPushButton(self.centralwidget)
        self.pushButton_resetarms.setObjectName(u"pushButton_resetarms")
        sizePolicy2 = QSizePolicy(QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Minimum)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.pushButton_resetarms.sizePolicy().hasHeightForWidth())
        self.pushButton_resetarms.setSizePolicy(sizePolicy2)
        font1 = QFont()
        font1.setPointSize(18)
        font1.setBold(True)
        self.pushButton_resetarms.setFont(font1)

        self.horizontalLayout_6.addWidget(self.pushButton_resetarms)

        self.pushButton_resetcameras = QPushButton(self.centralwidget)
        self.pushButton_resetcameras.setObjectName(u"pushButton_resetcameras")
        sizePolicy2.setHeightForWidth(self.pushButton_resetcameras.sizePolicy().hasHeightForWidth())
        self.pushButton_resetcameras.setSizePolicy(sizePolicy2)
        self.pushButton_resetcameras.setFont(font1)

        self.horizontalLayout_6.addWidget(self.pushButton_resetcameras)
        ...
        self.label_cameraFeed = QLabel(self.centralwidget)
        self.label_cameraFeed.setObjectName(u"label_cameraFeed")

        self.horizontalLayout_7.addWidget(self.label_cameraFeed)

        self.label_cameraFeedValue = QLabel(self.centralwidget)
        self.label_cameraFeedValue.setObjectName(u"label_cameraFeedValue")

        self.horizontalLayout_7.addWidget(self.label_cameraFeedValue)
        ...
        self.label_speed_warning = QLabel(self.centralwidget)
        self.label_speed_warning.setObjectName(u"label_speed_warning")
        sizePolicy3 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Fixed)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.label_speed_warning.sizePolicy().hasHeightForWidth())
        self.label_speed_warning.setSizePolicy(sizePolicy3)
        self.label_speed_warning.setMinimumSize(QSize(0, 44))
        font2 = QFont()
        font2.setPointSize(16)
        font2.setBold(True)
        self.label_speed_warning.setFont(font2)
        self.label_speed_warning.setAlignment(Qt.AlignCenter)

        self.verticalLayout_4.addWidget(self.label_speed_warning)

        self.gridLayout = QGridLayout()
        self.gridLayout.setObjectName(u"gridLayout")
        self.label_cameraFeed2 = QLabel(self.centralwidget)
        self.label_cameraFeed2.setObjectName(u"label_cameraFeed2")

        self.gridLayout.addWidget(self.label_cameraFeed2, 0, 1, 1, 1)

        self.label_cameraFeed1 = QLabel(self.centralwidget)
        self.label_cameraFeed1.setObjectName(u"label_cameraFeed1")

        self.gridLayout.addWidget(self.label_cameraFeed1, 0, 0, 1, 1)
        ...
        sizePolicy4.setHeightForWidth(self.openGLWidget_camera_2.sizePolicy().hasHeightForWidth())
        self.openGLWidget_camera_2.setSizePolicy(sizePolicy4)
        self.openGLWidget_camera_2.setMinimumSize(QSize(300, 300))

        self.gridLayout.addWidget(self.openGLWidget_camera_2, 3, 0, 1, 1)
        ...
        sizePolicy4.setHeightForWidth(self.openGLWidget_camera_1.sizePolicy().hasHeightForWidth())
        self.openGLWidget_camera_1.setSizePolicy(sizePolicy4)
        self.openGLWidget_camera_1.setMinimumSize(QSize(300, 300))

        self.gridLayout.addWidget(self.openGLWidget_camera_1, 1, 1, 1, 1)
        ...
        sizePolicy4.setHeightForWidth(self.openGLWidget_camera_3.sizePolicy().hasHeightForWidth())
        self.openGLWidget_camera_3.setSizePolicy(sizePolicy4)
        self.openGLWidget_camera_3.setMinimumSize(QSize(300, 300))

        self.gridLayout.addWidget(self.openGLWidget_camera_3, 3, 1, 1, 1)
        ...
        sizePolicy4.setHeightForWidth(self.openGLWidget_camera_0.sizePolicy().hasHeightForWidth())
        self.openGLWidget_camera_0.setSizePolicy(sizePolicy4)
        self.openGLWidget_camera_0.setMinimumSize(QSize(300, 300))

        self.gridLayout.addWidget(self.openGLWidget_camera_0, 1, 0, 1, 1)

        self.label_cameraFeed3 = QLabel(self.centralwidget)
        self.label_cameraFeed3.setObjectName(u"label_cameraFeed3")

        self.gridLayout.addWidget(self.label_cameraFeed3, 2, 0, 1, 1)

        self.label_cameraFeed4 = QLabel(self.centralwidget)
        self.label_cameraFeed4.setObjectName(u"label_cameraFeed4")

        self.gridLayout.addWidget(self.label_cameraFeed4, 2, 1, 1, 1)
        ...
        sizePolicy6.setHeightForWidth(self.comboBox_task_selection.sizePolicy().hasHeightForWidth())
        self.comboBox_task_selection.setSizePolicy(sizePolicy6)
        ...
        sizePolicy5.setHeightForWidth(self.label_object.sizePolicy().hasHeightForWidth())
        self.label_object.setSizePolicy(sizePolicy5)
        self.label_object.setMinimumSize(QSize(0, 40))
        self.label_object.setMaximumSize(QSize(435, 16777215))
        font3 = QFont()
        font3.setPointSize(18)
        self.label_object.setFont(font3)
        ...
        sizePolicy6.setHeightForWidth(self.comboBox_episode_object.sizePolicy().hasHeightForWidth())
        self.comboBox_episode_object.setSizePolicy(sizePolicy6)
...
#endif
        self.comboBox_episode_object.setPalette(palette3)
        font4 = QFont()
        font4.setPointSize(16)
        self.comboBox_episode_object.setFont(font4)
        ...
        sizePolicy5.setHeightForWidth(self.label_instruction_preview.sizePolicy().hasHeightForWidth())
        self.label_instruction_preview.setSizePolicy(sizePolicy5)
        self.label_instruction_preview.setMaximumSize(QSize(435, 16777215))
        self.label_instruction_preview.setWordWrap(True)
        font5 = QFont()
        font5.setPointSize(12)
        font5.setItalic(True)
        self.label_instruction_preview.setFont(font5)
        ...
        sizePolicy5.setHeightForWidth(self.label_task_history.sizePolicy().hasHeightForWidth())
        self.label_task_history.setSizePolicy(sizePolicy5)
        self.label_task_history.setMaximumSize(QSize(435, 16777215))
        self.label_task_history.setWordWrap(True)
        font6 = QFont()
        font6.setPointSize(11)
        self.label_task_history.setFont(font6)
        ...
        sizePolicy8.setHeightForWidth(self.pushButton_episode_count_minus.sizePolicy().hasHeightForWidth())
        self.pushButton_episode_count_minus.setSizePolicy(sizePolicy8)
        ...
        font7.setBold(True)
        self.spinBox_episode_count.setFont(font7)
        ...
        sizePolicy8.setHeightForWidth(self.pushButton_episode_count_plus.sizePolicy().hasHeightForWidth())
        self.pushButton_episode_count_plus.setSizePolicy(sizePolicy8)
        ...
        sizePolicy6.setHeightForWidth(self.pushButton_start_recording.sizePolicy().hasHeightForWidth())
        self.pushButton_start_recording.setSizePolicy(sizePolicy6)
        ...
        font8.setBold(True)
        self.pushButton_start_recording.setFont(font8)
        ...
        sizePolicy6.setHeightForWidth(self.pushButton_stop_recording.sizePolicy().hasHeightForWidth())
        self.pushButton_stop_recording.setSizePolicy(sizePolicy6)
        ...
        self.pushButton_stop_recording.setFont(font8)
        ...
        sizePolicy6.setHeightForWidth(self.pushButton_rerecord.sizePolicy().hasHeightForWidth())
        self.pushButton_rerecord.setSizePolicy(sizePolicy6)
        ...
        self.pushButton_rerecord.setFont(font8)
        ...
        sizePolicy6.setHeightForWidth(self.pushButton_finish_episode.sizePolicy().hasHeightForWidth())
        self.pushButton_finish_episode.setSizePolicy(sizePolicy6)
        ...
        self.pushButton_finish_episode.setFont(font8)
        ...
        sizePolicy6.setHeightForWidth(self.pushButton_fail_episode.sizePolicy().hasHeightForWidth())
        self.pushButton_fail_episode.setSizePolicy(sizePolicy6)
        ...
        self.pushButton_fail_episode.setFont(font8)
        ...
        sizePolicy6.setHeightForWidth(self.pushButton_dryrun.sizePolicy().hasHeightForWidth())
        self.pushButton_dryrun.setSizePolicy(sizePolicy6)
        self.pushButton_dryrun.setMinimumSize(QSize(150, 150))
        self.pushButton_dryrun.setMaximumSize(QSize(244, 16777215))
        self.pushButton_dryrun.setFont(font8)
        ...
        self.pushButton_skip_reset = QPushButton(self.centralwidget)
        self.pushButton_skip_reset.setObjectName(u"pushButton_skip_reset")
        self.pushButton_skip_reset.setEnabled(False)
        sizePolicy3.setHeightForWidth(self.pushButton_skip_reset.sizePolicy().hasHeightForWidth())
        self.pushButton_skip_reset.setSizePolicy(sizePolicy3)
        self.pushButton_skip_reset.setMinimumSize(QSize(0, 60))
        palette11 = QPalette()
        brush30 = QBrush(QColor(0, 172, 193, 255))
        ...
        self.pushButton_skip_reset.setPalette(palette11)
        self.pushButton_skip_reset.setFont(font2)

        self.verticalLayout.addWidget(self.pushButton_skip_reset)
        ...
        sizePolicy5.setHeightForWidth(self.label_recording_progress.sizePolicy().hasHeightForWidth())
        self.label_recording_progress.setSizePolicy(sizePolicy5)
        ...
        sizePolicy6.setHeightForWidth(self.progressBar_recording_progress.sizePolicy().hasHeightForWidth())
        self.progressBar_recording_progress.setSizePolicy(sizePolicy6)
        ...
        self.progressBar_recording_progress.setPalette(palette12)
        ...
        self.menuBar.setGeometry(QRect(0, 0, 1903, 23))
        ...
        self.menuEdit.addAction(self.actionNew_Task)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionNew_Task.setText(QCoreApplication.translate("MainWindow", u"New Task...", None))
        ...
        self.pushButton_resetarms.setText(QCoreApplication.translate("MainWindow", u"RESET ARMS", None))
        self.pushButton_resetcameras.setText(QCoreApplication.translate("MainWindow", u"HARDWARE RESET CAMERAS", None))
        self.label_cameraFeed.setText(QCoreApplication.translate("MainWindow", u"Camera Feed Display FPS:", None))
        self.label_cameraFeedValue.setText(QCoreApplication.translate("MainWindow", u"0", None))
        self.label_speed_warning.setText("")
        self.label_cameraFeed2.setText("")
        self.label_cameraFeed1.setText("")
        self.label_cameraFeed3.setText("")
        self.label_cameraFeed4.setText("")
...
"RUN", None))
        self.pushButton_skip_reset.setText(QCoreApplication.translate("MainWindow", u"SETUP DONE \u2014 START NEXT EPISODE NOW", None))
